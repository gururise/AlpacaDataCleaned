...
## Benchmark Results
Using the benchmarking tool in the eval folder, we compare two LORA models, one trained on the original alpaca dataset and another trained on the cleaned dataset (snapshot Mar 27).
